...
public class RegisterPageUIs {
	// define duy nhất ở đây không trùng lặp chỗ khác
	//màn hình nào quản lý element của màn hình nó
	public static final String FIRSTNAME_TEXTBOX = "//input[@id='FirstName']";
	public static final String LASTTNAME_TEXTBOX = "//input[@id='LastName']";
	public static final String EMAIL_TEXTBOX = "//input[@id='Email']";
	public static final String PASSWORD_TEXTBOX = "//input[@id='Password']";
	public static final String COMFIMPASSWORD_TEXTBOX = "//input[@id='ConfirmPassword']";
	...
	public static final String COMFIRMPASSWORD_ERROR_MSG = "//span[@id='ConfirmPassword-error']";
	...
	//không viết sai chính tả tiếng anh
